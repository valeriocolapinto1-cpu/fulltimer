      ...
      body: solves.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, i) {
                ...
                final isBest = solve.isValid && solve.effectiveMilliseconds == bestMs;
                return TimeListTile(
                  solve: solve,
                  index: originalIndex,
                  isBest: isBest,
                  ...
                  onOk:      () => session.updateSolveResult(solve.id, SolveResult.ok),
                  onPlusTwo: () => session.updateSolveResult(solve.id, SolveResult.plusTwo),
                  onDnf:     () => session.updateSolveResult(solve.id, SolveResult.dnf),
                );
              },
            ),
    );
